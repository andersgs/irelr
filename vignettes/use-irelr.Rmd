...
# at the moment, the individuals might just get sequential numbers
...
ind_identifiers
adegenet::indNames(data) <- ind_identifiers
adegenet::indNames(data)
```
...
Once the data is loaded, we can use the function `estimate_rel()` to 
